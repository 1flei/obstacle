...
nlohmann::json test_density(std::unordered_map<int, Traj>& traj_dict_q, std::unordered_map<int, Traj>& traj_dict, LSH_KDE_BKS& index, double sigma, 
...
int main(int argc, char **argv)
{
    ...
    desc.add_options()
        ...
        ("nrepeat,t", value(&nrepeat), "# repeated for the LSH_KDE_BKS")
        ("bottom_k_sketch_size,m", value(&bottom_k_sketch_size), "size of the bottom k sketch")
    ...
    LSH_KDE_BKS index(sliding_window_len*2, k, l, sigma*r, bottom_k_sketch_size, nrepeat);
    LSH_KDE_BKS index_q(sliding_window_len*2, k, l, sigma*r, bottom_k_sketch_size, nrepeat);
